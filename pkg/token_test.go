	...
	tests := []struct {
	...
	}{
		{
			...
			expected: []TokenInfo{
				...
				{Token: EOF, Line: 1, Column: 1, Literal: "", Len: 0},
			},
		},
		{
			name:  "Child",
			...
			expected: []TokenInfo{
				...
				{Token: LITERAL, Line: 1, Column: 2, Literal: "store", Len: 5},
				{Token: CHILD, Line: 1, Column: 7, Literal: "", Len: 1},
				{Token: LITERAL, Line: 1, Column: 8, Literal: "book", Len: 4},
				{Token: EOF, Line: 1, Column: 12, Literal: "", Len: 0},
			},
		},
		{
			name:  "Wildcard",
			...
			expected: []TokenInfo{
				...
				{Token: EOF, Line: 1, Column: 3, Literal: "", Len: 0},
			},
		},
		{
			name:  "Recursive",
			...
			expected: []TokenInfo{
				...
				{Token: CHILD, Line: 1, Column: 2, Literal: "", Len: 1},
				{Token: LITERAL, Line: 1, Column: 3, Literal: "author", Len: 6},
				{Token: EOF, Line: 1, Column: 9, Literal: "", Len: 0},
			},
		},
		{
			name:  "Union",
			...
			expected: []TokenInfo{
				...
				{Token: RECURSIVE, Line: 1, Column: 1, Literal: "", Len: 2},
				{Token: CHILD, Line: 1, Column: 2, Literal: "", Len: 1},
				{Token: LITERAL, Line: 1, Column: 3, Literal: "book", Len: 4},
		...
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: BRACKET_LEFT, Line: 1, Column: 7, Literal: "", Len: 1},
				{Token: NUMBER, Line: 1, Column: 8, Literal: "0", Len: 1},
				{Token: SLICE, Line: 1, Column: 9, Literal: "", Len: 1},
		...
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: CHILD, Line: 1, Column: 7, Literal: "", Len: 1},
				{Token: LITERAL, Line: 1, Column: 8, Literal: "book", Len: 4},
				{Token: FILTER_LEFT, Line: 1, Column: 12, Literal: "", Len: 2},
				...
				{Token: LITERAL, Line: 1, Column: 17, Literal: "price", Len: 5},
				...
				{Token: FILTER_RIGHT, Line: 1, Column: 28, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 29, Literal: "", Len: 0},
			},
		},
		{
			...
			expected: []TokenInfo{
				{Token: ROOT, Line: 1, Column: 0, Literal: "", Len: 1},
				{Token: FILTER_LEFT, Line: 1, Column: 1, Literal: "", Len: 2},
				...
				{Token: LITERAL, Line: 1, Column: 6, Literal: "child", Len: 5},
				...
				{Token: FILTER_RIGHT, Line: 1, Column: 17, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 18, Literal: "", Len: 0},
			},
		},
		{
		...
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: FILTER_RIGHT, Line: 1, Column: 14, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 15, Literal: "", Len: 0},
			},
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: FILTER_RIGHT, Line: 1, Column: 15, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 16, Literal: "", Len: 0},
			},
		},
		{
		...
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: LITERAL, Line: 1, Column: 15, Literal: "other", Len: 5},
				{Token: PAREN_RIGHT, Line: 1, Column: 20, Literal: "", Len: 1},
				{Token: FILTER_RIGHT, Line: 1, Column: 21, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 22, Literal: "", Len: 0},
			},
		},
		{
		...
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: LITERAL, Line: 1, Column: 7, Literal: "child", Len: 5},
				{Token: PAREN_RIGHT, Line: 1, Column: 12, Literal: "", Len: 1},
				{Token: FILTER_RIGHT, Line: 1, Column: 13, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 14, Literal: "", Len: 0},
			},
		},
		{
			...
			expected: []TokenInfo{
				...
				{Token: REGEX_LITERAL, Line: 1, Column: 13, Literal: ".*", Len: 4},
				{Token: PAREN_RIGHT, Line: 1, Column: 17, Literal: "", Len: 1},
				{Token: FILTER_RIGHT, Line: 1, Column: 18, Literal: "", Len: 1},
				{Token: EOF, Line: 1, Column: 19, Literal: "", Len: 0},
			},
		},
	}
